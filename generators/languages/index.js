...
module.exports = class extends LanguagesGenerator {
    constructor(args, opts) {
        ...
        if (!jhContext) {
            this.error(`This is a JHipster blueprint and should be used only like ${chalk.yellow('jhipster --blueprint stefit')}`);
        }
    ...
    get writing() {
        ...
        return { ...phaseFromJHipster, ...phaseFromStefit };
    }
